...
class ST_GCN_18_ordinal_orig_position_pretrain(ST_GCN_18_position_pretrain_model):
    ...
    def __init__(self, in_channels, num_class, graph_cfg, **kwargs):
        super().__init__(in_channels, num_class, graph_cfg, ST_GCN_18_ordinal_orig_encoder, **kwargs)
