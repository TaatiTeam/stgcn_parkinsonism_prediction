...
from .st_gcn_aaai18_ordinal_encoder_dynamic_v1 import ST_GCN_18_ordinal_encoder_dynamic_v1

class ST_GCN_18_ordinal_orig_position_pretrain_dynamic_v1(nn.Module):
    ...
    def __init__(self,
        ...
        print(kwargs)
        self.encoder = ST_GCN_18_ordinal_encoder_dynamic_v1(
                 in_channels,
                 num_class,
                 graph_cfg,
    ...
    def addLayer(self, mult_size):
        self.encoder.addLayer(mult_size)
